...
export class PurchaseGuestGiftCardDto {
  @ApiProperty({ enum: GiftCardType, description: "Type of gift card: DIGITAL or CORPORATE_BULK" })
  @IsEnum(GiftCardType)
  type!: GiftCardType;
  ...
  @ApiProperty({ description: "Purchaser's full name" })
  @IsNotEmpty()
  @IsString()
  purchaserName!: string;

  @ApiProperty({ description: "Purchaser's email address" })
  @IsEmail()
